...
const Navbar = () => {
  ...
  return (
    <div className='sticky top-0 z-50 bg-white flex items:center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
        <img onClick={()=>navigate('/') } className='w-[176px] h-[44px] cursor-pointer' src={assets.logo3} alt=''/>
            ...
            <div className={`${showmenu ? 'fixed w-full':'w-0 h-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all` }>
                ...
                <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium'>
                    ...
                    <a 
                        ...
                        className='px-4 py-2 rounded inline-block border px-2.5 py-0.5 rounded-full border-gray-500 text-gray-600'
                     >
                        ADMIN PANEL
                    </a>
                </ul>
